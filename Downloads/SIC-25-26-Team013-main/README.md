...
| :--- | :--- | :--- | :--- |
| **🤖 AI Research Agent** | [**Click to Chat**](https://huggingface.co/spaces/CodeByDiablo/RAG-Agent) | *Hosted on HF Spaces* | 🟡 Pending Deployment |
...
* **`deployment_source/`**: Full source code archives for the live apps.
    * `rag_backend/`: LangChain + FAISS implementation.
